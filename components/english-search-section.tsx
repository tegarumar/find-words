      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div style={{
          ...
          <div style={{ position: 'relative' }}>
            ...
            <input
              ...
              onBlur={e => {
                ...
                e.target.style.boxShadow = prefix ? '0 0 10px #00ffff30' : 'inset 0 0 10px #00000040';
              }}
            />
          </div>
          ...
          <p style={{
            ...
            {'// '}<span style={{ color: '#e0e0ff' }}>ap</span> → apple, apply, april
          </p>
        </div>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative' }}>
            ...
            <input
              ...
              onBlur={e => {
                ...
                e.target.style.boxShadow = suffix ? '0 0 10px #ff00ff30' : 'inset 0 0 10px #00000040';
              }}
            />
          </div>
          ...
          <p style={{
            ...
            {'// '}<span style={{ color: '#e0e0ff' }}>ing</span> → running, playing, going
          </p>
        </div>
      </div>
      ...
      <div style={{
        ...
        {prefix || suffix ? (
          <>
            ...
            {prefix && suffix && (
              <span>
                {' '}· PFX:<span style={{ color: '#ffff00', marginLeft: '4px' }}>{prefix}</span>
                {' '}· SFX:<span style={{ color: '#ffff00', marginLeft: '4px' }}>{suffix}</span>
              </span>
            )}
            {prefix && !suffix && (
              <span>· PFX:<span style={{ color: '#ffff00', marginLeft: '4px' }}>{prefix}</span></span>
            )}
            {!prefix && suffix && (
              <span>· SFX:<span style={{ color: '#ffff00', marginLeft: '4px' }}>{suffix}</span></span>
            )}
          </>
        ) : (
